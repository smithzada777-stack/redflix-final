            ...
            <main className="flex-1 overflow-y-auto h-[100dvh] md:h-screen relative pt-16 md:pt-0">
                {activeTab === 'overview' && (
                    <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto">
                        ...
                        {/* KPI Grid - ALL RED CARDS */}
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            {/* Revenue - RED */}
                            <div className="bg-gradient-to-br from-red-600 to-red-800 p-6 rounded-2xl shadow-[0_10px_30px_rgba(220,38,38,0.4)] border border-red-500/30 relative overflow-hidden group">
                                <div className="absolute right-0 top-0 p-4 opacity-10 group-hover:scale-110 transition-transform">
                                    <DollarSign size={60} />
                                </div>
                                <div className="flex justify-between items-start mb-2">
                                    <h3 className="text-[10px] font-black uppercase tracking-widest text-white/90">Receita Gerada</h3>
                                    <div className="flex flex-col items-end">
                                        <span className="text-[8px] font-black text-white/40 uppercase tracking-widest">Status Nexus</span>
                                ...
                                <p className="text-2xl md:text-3xl font-black text-white italic mt-1">{formatCurrency(metrics.revenue)}</p>
                            </div>

                            {/* Pending Sales - RED */}
                            <div className="bg-gradient-to-br from-red-700 to-red-900 p-6 rounded-2xl shadow-[0_10px_30px_rgba(220,38,38,0.3)] border border-red-600/30 relative overflow-hidden group">
                                <div className="absolute right-0 top-0 p-4 opacity-10 group-hover:scale-110 transition-transform">
                                    <Clock size={60} />
                                </div>
                                <h3 className="text-[10px] font-black uppercase tracking-widest text-white/90">Vendas Pendentes</h3>
                                <p className="text-2xl md:text-3xl font-black text-white italic mt-1">{formatCurrency(metrics.pendingRevenue)}</p>
                                <p className="text-[9px] text-white/60 mt-1">{metrics.pending} aguardando pagamento</p>
                            </div>

                            {/* Best Selling Plan - RED */}
                            <div className="bg-gradient-to-br from-red-800 to-black p-6 rounded-2xl shadow-[0_10px_30px_rgba(220,38,38,0.3)] border border-red-700/30 relative overflow-hidden group">
                                <div className="absolute right-0 top-0 p-4 opacity-10 group-hover:scale-110 transition-transform">
                                    <CheckCircle2 size={60} />
                                </div>
                                <h3 className="text-[10px] font-black uppercase tracking-widest text-red-400">Plano Mais Vendido</h3>
                                <p className="text-lg md:text-2xl font-black text-white italic mt-1 truncate">{metrics.bestPlan}</p>
                                <p className="text-[9px] text-white/60 mt-1">{metrics.bestPlanCount} vendas totais</p>
                            </div>

                            {/* Conversion - RED */}
                            <div className="bg-gradient-to-br from-red-900 to-black p-6 rounded-2xl shadow-[0_10px_30px_rgba(220,38,38,0.3)] border border-red-800/30 relative overflow-hidden group">
                                <div className="absolute right-0 top-0 p-4 opacity-10 group-hover:scale-110 transition-transform">
                                    <TrendingUp size={60} />
                                </div>
                                <h3 className="text-[10px] font-black uppercase tracking-widest text-red-500">Taxa de Conversão</h3>
                                <p className="text-2xl md:text-3xl font-black text-white italic mt-1">{metrics.conversion.toFixed(1)}%</p>
                                <p className="text-[9px] text-white/60 mt-1">Leads para Vendas</p>
                            </div>
                        </div>
